...
void reverse_entire_linked_list(struct node **head){
    if(*head == NULL){
        printf("\n The linked list already empty! ");
    }
    else{
...
int main(){
    ...
    printf("\n The linked list before inserting few more nodes is");
    print_list(head);
    ...
    printf("\n\n The linked list after adding few more nodes is");
    print_list(head);
    
    delete_node_at_beginning(&head);
    printf("\n\n The linked list after deleting a node at the beginning of the linked list is");
    print_list(head);
    ...
    printf("\n\n The linked list after deleting a node at certain position is");
    print_list(head);

    reverse_entire_linked_list(&head);
